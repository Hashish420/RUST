...
const string strMessageMagic = "Rust Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Rust", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1469058308, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = " justin is the king of pop 07 20 2016";
        CTransaction txNew;
        txNew.nTime = 1469058308;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1469058308;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3116093 : 3116093;
        ...
        assert(block.hashMerkleRoot == uint256("0xac1fd86be7607b5b4a56fbb9f3ec383ed7d5c9d01d8104fcf777391690b112ab"));
...
unsigned char pchMessageStart[4] = { 0x76, 0xb9, 0x50, 0xd6 };
